...
In order to support loading of multiple wallets in slashdash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is slashdash.cpp.
...
Changes to slashdash.cpp
----------------------
slashdash.cpp is the entry point into slashdash-qt, and as such, will require some minor modifications to provide hooks for
