Contributing to SDASH Core
============================

The SDASH Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SDASH Core project, and is not to be
confused with overall SDASH Network Protocol consensus changes.

Whether a pull request is merged into SDASH Core rests with the project merge
...
Patches that change SDASH consensus rules are considerably more involved than
...
Where a patch set proposes to change the SDASH consensus, it must have been
...
The project leader is the release manager for each SDASH Core release.
