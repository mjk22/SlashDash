...
This means one can have an always-on divid instance running, and another local divid/slashdash-qt instance which connects to this node and receives blocks from it.
