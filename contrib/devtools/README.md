...
Setup
---------
Configuring the github-merge tool for the SDASH repository is done in the following way:

    git config githubmerge.repository divicoin/slashdash
...
A script to optimize png files in the SDASH
