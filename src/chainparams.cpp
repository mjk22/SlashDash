...
// Copyright (c) 2018 The SlashDash Developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000000009bc4512f614a3b70f6e67a7769266a8d480f95dba05c08b29b3e7d57"));
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1526244252, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51223;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // SDASH starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // SDASH: 1 day
        nTargetSpacing = 1 * 60;  // SDASH: 1 minute
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "May 13, 2018 - Once the lava stops, future uncertain in Hawaii";
        ...
        assert(hashGenesisBlock == uint256("0x000000009bc4512f614a3b70f6e67a7769266a8d480f95dba05c08b29b3e7d57"));
        assert(genesis.hashMerkleRoot == uint256("c01a53f4afd9574de094e2de2b8c6662609150432015055e5effa8a940eb1eca"));

        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "sdash.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "sdash.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
        ...
        // 	BIP44 coin type is from https://github.sscom/satoshilabs/slips/blob/master/slip-0044.md
...
public:
    CTestNetParams()
    {
        ...
        */
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "sdash-testnet.seed.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "sdash-testnet.seed2.fuzzbawls.pw"));
        //vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        //vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 127); // Testnet sdash addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet sdash script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet sdash BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet sdash BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet sdash BIP44 coin type is '1' (All coin's testnet default)
