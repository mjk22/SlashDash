                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SDASH Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SDASH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and slashdash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SDASH Core"), this);
    aboutAction->setStatusTip(tr("Show information about SDASH Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SDASH"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SDASH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SDASH addresses"));
    ...
    openAction->setStatusTip(tr("Open a SDASH: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SDASH Core help message to get a list with possible SDASH command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SDASH Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SDASH network", "", count));
}
...
{
    QString strTitle = tr("SDASH Core"); // default title
