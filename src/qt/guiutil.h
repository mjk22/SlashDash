...
/** Utility functions used by the SDASH Qt UI.
 */
namespace GUIUtil
{
...
// Render SDASH addresses in monospace font
...
// Parse "slashdash:" URI into recipient object, return true on successful parsing
