...
/** 
    ...
    ****Note - for SDASH we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of slashdash coming in to a transaction
