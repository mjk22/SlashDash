...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SlashDash Core slashdash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  slashdash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded slashdash transaction") + "\n" +
                               "  slashdash-tx [options] -create [commands]   " + _("Create hex-encoded slashdash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded slashdash transaction
